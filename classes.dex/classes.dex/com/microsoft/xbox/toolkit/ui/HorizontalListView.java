...
public class HorizontalListView extends AdapterView<ListAdapter> {
    private static final int FLING_BLOCK_TIMEOUT_MS = 1000;
    private static final int SCROLL_BLOCK_TIMEOUT_MS = 500;
    ...
    private OnGestureListener mOnGesture = new SimpleOnGestureListener() {
        public boolean onDown(MotionEvent e) {
            BackgroundThreadWaitor.getInstance().setBlocking(WaitType.ListScroll, 500);
            return HorizontalListView.this.onDown(e);
        }

        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            BackgroundThreadWaitor.getInstance().setBlocking(WaitType.ListScroll, 1000);
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
            ...
            HorizontalListView.this.requestLayout();
            if (HorizontalListView.this.onScrollListener != null) {
                HorizontalListView.this.onScrollListener.onScroll(HorizontalListView.this.mLeftViewIndex, HorizontalListView.this.mRightViewIndex, distanceX);
            }
            return true;
        }
    ...
    private void addAndMeasureChild(View child, int viewPos) {
        ...
        child.measure(MeasureSpec.makeMeasureSpec(getWidth(), AvatarEditorModel.AVATAREDIT_OPTION_COLOR_FACIAL_HAIR), MeasureSpec.makeMeasureSpec(getHeight(), AvatarEditorModel.AVATAREDIT_OPTION_COLOR_FACIAL_HAIR));
    }
