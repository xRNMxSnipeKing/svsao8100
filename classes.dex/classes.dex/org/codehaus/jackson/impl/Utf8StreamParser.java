        ...
        while (true) {
            ...
            if (codes[ch] != 0) {
                ...
                if (ch > 127) {
                    ...
                    if (ch < AvatarEditorModel.AVATAREDIT_OPTION_EARRINGS) {
    ...
    private final Name addName(int[] quads, int qlen, int lastQuadBytes) throws JsonParseException {
        ...
        while (ix < byteLen) {
            ...
            if (i2 > 127) {
                ...
                if (needed > 2) {
                    i2 -= AvatarEditorModel.AVATAREDIT_OPTION_FEATURES_FACIAL_HAIR;
                    if (cix >= cbuf.length) {
...
*/
    ...
    private final int _decodeUtf8_4(int c) throws IOException, JsonParseException {
        ...
        return ((c << 6) | (d & 63)) - AvatarEditorModel.AVATAREDIT_OPTION_FEATURES_FACIAL_HAIR;
    }
