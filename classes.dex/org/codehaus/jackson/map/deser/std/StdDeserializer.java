        ...
        if (t == JsonToken.VALUE_STRING) {
            ...
            try {
                ...
                if (len > 9) {
                    ...
                    throw ctxt.weirdStringException(this._valueClass, "Overflow: numeric value (" + text + ") out of range of int (" + AvatarEditorModel.AVATAREDIT_OPTION_COLOR_FACIAL_HAIR + " - " + Integer.MAX_VALUE + ")");
                } else if (len != 0) {
        ...
        if (t == JsonToken.VALUE_STRING) {
            ...
            try {
                ...
                if (len > 9) {
                    ...
                    throw ctxt.weirdStringException(this._valueClass, "Overflow: numeric value (" + text + ") out of range of Integer (" + AvatarEditorModel.AVATAREDIT_OPTION_COLOR_FACIAL_HAIR + " - " + Integer.MAX_VALUE + ")");
                } else if (len == 0) {
